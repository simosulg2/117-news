...
export function PeriodSummary({ points, startValue, endValue, onStartChange, onEndChange, maximumValue }: PeriodSummaryProps) {
  ...
  return (
    <details aria-labelledby="period-heading" className="group border border-[#9fb2c0] bg-[#f4f7f9] dark:border-[#35536a] dark:bg-[#0a1926]">
      <summary className="flex min-h-12 cursor-pointer list-none items-center justify-between gap-3 px-3 py-3 outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-signal [&::-webkit-details-marker]:hidden">
        <span>
          <span id="period-heading" className="block text-sm font-bold text-[#192630] dark:text-[#e5eef4]">Ajavahemiku ülevaade</span>
          <span className="mt-0.5 block text-[11px] text-[#526878] dark:text-[#8da1b0]">Vali aeg ja vaata perioodi koondnäite.</span>
        </span>
        <svg aria-hidden="true" viewBox="0 0 20 20" className="size-4 shrink-0 text-[#456070] transition-transform group-open:rotate-180 motion-reduce:transition-none dark:text-[#9aabb7]" fill="none" stroke="currentColor" strokeWidth="2">
          <path d="m5 7.5 5 5 5-5" />
        </svg>
      </summary>
      <div className="border-t border-[#bdcad3] dark:border-[#294154]">
        <div className="grid gap-3 border-b border-[#bdcad3] px-3 py-3 dark:border-[#294154] lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
          <p className="max-w-2xl text-xs leading-5 text-[#526878] dark:text-[#8da1b0]">
